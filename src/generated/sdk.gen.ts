 ...
 * Get metadata about available API scopes and permissions (public endpoint, no authentication required)
 */
export const getScopesMetadata = <ThrowOnError extends boolean = false>(options?: Options<GetScopesMetadataData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetScopesMetadataResponses, GetScopesMetadataErrors, ThrowOnError>({
 ...
 */
export const introspectToken = <ThrowOnError extends boolean = false>(options?: Options<IntrospectTokenData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<IntrospectTokenResponses, IntrospectTokenErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * Fetches multiple entities by their unique identifiers (UIDs) in a single request. More efficient than multiple individual requests. Requires 'read:entities' permission.
 */
export const getEntitiesByUidBatch = <ThrowOnError extends boolean = false>(options: Options<GetEntitiesByUidBatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetEntitiesByUidBatchResponses, GetEntitiesByUidBatchErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * Fetches a specific entity by its unique identifier (UID), including related entities and relations. Supports optional field projection. Requires 'read:entities' permission.
 */
 ...
 * Lists all relations in the namespace with optional filtering by labels. Requires 'read:entityrelations' permission.
 */
export const listEntityRelations = <ThrowOnError extends boolean = false>(options: Options<ListEntityRelationsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListEntityRelationsResponses, ListEntityRelationsErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getOidcConfiguration = <ThrowOnError extends boolean = false>(options?: Options<GetOidcConfigurationData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetOidcConfigurationResponses, GetOidcConfigurationErrors, ThrowOnError>({
...
/**
 * List Discovery Images
 * List all approved discovery images
 */
export const listDiscoveryImages = <ThrowOnError extends boolean = false>(options?: Options<ListDiscoveryImagesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListDiscoveryImagesResponses, ListDiscoveryImagesErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
